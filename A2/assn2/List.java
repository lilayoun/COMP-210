...
public interface List {
  ...
  /* similar to contains, except that find returns the index of the item where
     element is stored; this locates the first such occurrence
     */
  public int size( ) ;
  ...
  /* A form of ins operations, but here we do not insert based on index;
     ...
     Note: if we use only inSort to add items to a list (don't use ins)
  ...
  /* Another form of ins operation.  In this one, we look through the list
     ...
     we take the first occurrence of it and move that element to the head of
